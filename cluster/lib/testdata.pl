...
my $FMT =<<_EOF_
{ _id: %d , loc: {x: %3.2f, y: %3.2f, z: %3.2f }, weight: %3.2f,  score: %3.2f }
_EOF_
;
my $FMT2 =<<_EOF_
{ _id: %d , loc: {x: %3.2f, y: %3.2f }, weight: %3.2f,  score: %3.2f }
_EOF_
;
my $FMT3 =<<_EOF_
{ _id: %d , loc: {x: %3.2f, z: %3.2f }, weight: %3.2f,  score: %3.2f }
_EOF_
;
my $FMT4 =<<_EOF_
{ _id: %d , loc: {y: %3.2f, z: %3.2f }, weight: %3.2f,  score: %3.2f }
_EOF_
;
