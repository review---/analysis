...
//  		);
		...
		if ( _VERBOSE ) {
			print('Reduced minor clusters:' + cluster_collection.count() + ' - ' + cluster_collection.find({'value.s':{ $lte : threshold}}).count());
		}
